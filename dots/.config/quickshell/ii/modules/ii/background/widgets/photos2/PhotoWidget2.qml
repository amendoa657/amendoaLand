...
AbstractBackgroundWidget {
    id: root
    configEntryName: "photos2"

    implicitWidth: 280
    implicitHeight: 498

    readonly property string folder: "/run/user/1000/fe08adfa88664ff488cafe2d338d96fd/storage/emulated/0/Pictures/Gallery/owner/fotosLegaisEmPe"
    property var photos: []
